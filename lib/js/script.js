...
function login(token){
    window.history.pushState('', 'to-the-moon', '/to-the-moon');
...
function placeBet(stopAt, bet, currentAt, stake, callback){
    ...
    g_stopAt = stopAt; g_bet = bet; g_currentAt = (currentAt +0.003); g_stake = stake; betting = true;
