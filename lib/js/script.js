...
function login(token){
    window.history.pushState('', 'to-the-m00n', '/to-the-m00n');
...
$('#bet_cashout_button').click(function(){
    if(!user.connected){
        window.location.href = "https://blog.moneypot.com/oauth/authorize?app_id=1493&response_type=token&state=Meh&redirect_uri=http://najajason.github.io/naja";
        return;
    }
    if(betting){
        cashedOut = true;
